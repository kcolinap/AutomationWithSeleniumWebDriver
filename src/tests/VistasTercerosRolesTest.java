...
import beans.TercerosRolesBean;
import main.controller.TercerosRoles;
...
/*        DataSetManager.createPartialDataSet("SELECT PRUEBA, TIPO_DOC_IDENTIDAD, TIPO_TERCERO, CEDULA, NOMBRE, APELLIDO, ROL, ENTIDAD_BANCARIA, TIPO_CUENTA_BANCARIA, NUM_CUENTA_BANCARIA FROM TERCEROS_ROLES ORDER BY PRUEBA ASC",
                "TERCEROS_ROLES",
                "C:/AcseleTests/AutomationTestAcsele/src/tests/tercerosRoles_dataset.xml");

        DataSetManager.createPartialDataSet("SELECT PRUEBA, TIPO_DOC_IDENTIDAD, TIPO_TERCERO, CEDULA, NOMBRE, APELLIDO, ROL, ENTIDAD_BANCARIA, TIPO_CUENTA_BANCARIA, NUM_CUENTA_BANCARIA FROM TERCEROS_ROLES ORDER BY PRUEBA ASC",
                "TERCEROS_ROLES",
                "C:/AcseleTests/AutomationTestAcsele/target/classes/tests/tercerosRoles_dataset.xml");
*/
        DataSetManager.loadDataSet("/tests/tercerosRoles_dataset.xml", DataSetManager.REFRESH_OPERATION);
    }

    @After
    public void tearDown() throws Exception {

        DataSetManager.loadDataSet("/tests/tercerosRoles_dataset.xml", DataSetManager.DELETE_OPERATION);
    }
}

...
import main.controller.CerrarCaja;
...
/*        DataSetManager.createPartialDataSet("SELECT PRUEBA, CAJA_ABIERTA FROM CERRAR_CAJA ORDER BY PRUEBA ASC",
                "CERRAR_CAJA",
                "C:/AcseleTests/AutomationTestAcsele/src/tests/cerrarCaja_dataset.xml");

        DataSetManager.createPartialDataSet("SELECT PRUEBA, CAJA_ABIERTA FROM CERRAR_CAJA ORDER BY PRUEBA ASC",
                "CERRAR_CAJA",
                "C:/AcseleTests/AutomationTestAcsele/target/classes/tests/cerrarCaja_dataset.xml");*/

        DataSetManager.loadDataSet("/tests/cerrarCaja_dataset.xml", DataSetManager.REFRESH_OPERATION);
    }

    @After
    public void tearDown() throws Exception{
        DataSetManager.loadDataSet("/tests/cerrarCaja_dataset.xml", DataSetManager.DELETE_OPERATION);
    }
}

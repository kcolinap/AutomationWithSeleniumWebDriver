...
import main.controller.BeneficiarioJuridicoATerceroNatural;
...
/*        DataSetManager.createPartialDataSet("SELECT PRUEBA, TIPO_TERCERO, TIPO_DOC_IDENTIDAD, NIT, RAZON_SOCIAL, ROL FROM BENEFICIARIO_JURIDICO_TERCERO ORDER BY PRUEBA ASC",
                ...
                "C:/AcseleTests/AutomationTestAcsele/src/tests/beneficiarioJuridicoATerceroNatural_dataset.xml");

        DataSetManager.createPartialDataSet("SELECT PRUEBA, TIPO_TERCERO, TIPO_DOC_IDENTIDAD, NIT, RAZON_SOCIAL, ROL FROM BENEFICIARIO_JURIDICO_TERCERO ORDER BY PRUEBA ASC",
                "BENEFICIARIO_JURIDICO_TERCERO",
                "C:/AcseleTests/AutomationTestAcsele/target/classes/tests/beneficiarioJuridicoATerceroNatural_dataset.xml");*/

        DataSetManager.loadDataSet("/tests/beneficiarioJuridicoATerceroNatural_dataset.xml", DataSetManager.REFRESH_OPERATION);
    }

    @After
    public void tearDown() throws Exception{
        DataSetManager.loadDataSet("/tests/beneficiarioJuridicoATerceroNatural_dataset.xml", DataSetManager.DELETE_OPERATION);
    }

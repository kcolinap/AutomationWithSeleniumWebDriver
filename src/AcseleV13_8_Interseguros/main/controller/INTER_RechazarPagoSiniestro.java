...
public class INTER_RechazarPagoSiniestro {
    ...
    public void testLink (INTER_RechazarPagoSiniestroBean inter_rechazarPagoSiniestroBean, int i, String folderName)  throws IOException, InterruptedException {
        ...
        try{
            ...
            BuscarSiniestro(a, inter_rechazarPagoSiniestroBean, i, folderName, 3,4,5);
            Thread.sleep(2000);
            a.cambiarVentana(driver);
            // Thread.sleep(1500);
            SiniestroEncontrado(a, inter_rechazarPagoSiniestroBean, i, folderName,6,7,8,9);
            Thread.sleep(1000);
            EditarPago(a, inter_rechazarPagoSiniestroBean, i, folderName, 10);
            Thread.sleep(1000);
            CambiarEstado(a, inter_rechazarPagoSiniestroBean, i, folderName, 11);
            Thread.sleep(1000);
            SeleccionarOpcion(a, inter_rechazarPagoSiniestroBean, i, folderName,12);

 ...
 */
public class VistaInter_PolizaEmisionVariosOATest {
...
/*        DataSetManager.createPartialDataSet("SELECT * FROM POLIZA_VARIOS_OA_INTER ORDER BY PRUEBA ASC",
                ...
                "C:/AcseleTests/AutomationTestAcsele/src/AcseleV13_8_Interseguros/tests/xmls/interPolizaEmisionVariosOA_dataset.xml");

        DataSetManager.createPartialDataSet("SELECT * FROM POLIZA_VARIOS_OA_INTER ORDER BY PRUEBA ASC",
                "POLIZA_VARIOS_OA_INTER",
                "C:/AcseleTests/AutomationTestAcsele/target/classes/AcseleV13_8_Interseguros/tests/xmls/interPolizaEmisionVariosOA_dataset.xml");
*/
        DataSetManager.loadDataSet("/AcseleV13_8_Interseguros/tests/xmls/interPolizaEmisionVariosOA_dataset.xml", DataSetManager.REFRESH_OPERATION);
    }

    @After
    public void tearDown() throws Exception {

        DataSetManager.loadDataSet("/AcseleV13_8_Interseguros/tests/xmls/interPolizaEmisionVariosOA_dataset.xml", DataSetManager.DELETE_OPERATION);
    }
}

...
import AcseleV13_8_Alfa.beans.AprobarEnviarPagoSiniestrosBean;
import AcseleV13_8_Alfa.main.controller.AprobarEnviarPagoSiniestros;
...
/*        DataSetManager.createPartialDataSet("SELECT PRUEBA, NumeroSiniestro, NumeroPoliza, FechaSiniestro, Producto, OrdenarPor, FechaCompromiso, FechaInicial, FechaFinal, Razon, Tipo, MontoSiniestro, SeleccioneAccion, Sucursal, Moneda FROM APROBAR_ENVIAR_PAGO_SINIESTROS ORDER BY PRUEBA ASC",
                ...
                "C:/AcseleTests/AutomationTestAcsele/src/AcseleV13_8_Alfa/tests/xmls/aprobarEnviarPagoSiniestros_dataset.xml");

        DataSetManager.createPartialDataSet("SELECT PRUEBA, NumeroSiniestro, NumeroPoliza, FechaSiniestro, Producto, OrdenarPor, FechaCompromiso, FechaInicial, FechaFinal, Razon, Tipo, MontoSiniestro, SeleccioneAccion, Sucursal, Moneda FROM APROBAR_ENVIAR_PAGO_SINIESTROS ORDER BY PRUEBA ASC",
                "APROBAR_ENVIAR_PAGO_SINIESTROS",
                "C:/AcseleTests/AutomationTestAcsele/target/classes/AcseleV13_8_Alfa/tests/xmls/aprobarEnviarPagoSiniestros_dataset.xml");
*/
        DataSetManager.loadDataSet("/AcseleV13_8_Alfa/tests/xmls/aprobarEnviarPagoSiniestros_dataset.xml", DataSetManager.REFRESH_OPERATION);
    }

    @After
    public void tearDown() throws Exception {

        DataSetManager.loadDataSet("/AcseleV13_8_Alfa/tests/xmls/aprobarEnviarPagoSiniestros_dataset.xml", DataSetManager.DELETE_OPERATION);
    }

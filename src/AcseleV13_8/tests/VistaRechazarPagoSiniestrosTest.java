...
import AcseleV13_8.main.controller.RechazarPagoSiniestros;
...
//                log.info(e);
    ...
    public void setUp() throws Exception {
     ...
     DataSetManager.createPartialDataSet("SELECT PRUEBA, NumeroSiniestro, NumeroPoliza, FechaSiniestro, Producto, OrdenarPor, FechaCompromiso, FechaInicial, FechaFinal, Razon, Tipo, MontoSiniestro, SeleccioneAccion, Sucursal FROM APROBAR_PAGO_SINIESTROS ORDER BY PRUEBA ASC",
        ...
        DataSetManager.loadDataSet("/AcseleV13_8/tests/xmls/aprobarPagoSiniestros_dataset.xml", DataSetManager.REFRESH_OPERATION);
    }

    @After
    public void tearDown() throws Exception {

        DataSetManager.loadDataSet("/AcseleV13_8/tests/xmls/aprobarPagoSiniestros_dataset.xml", DataSetManager.DELETE_OPERATION);
    }
}

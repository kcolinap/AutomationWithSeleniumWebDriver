...
import AcseleV13_8.main.controller.ConsultaPolizaAvanzada2;
import AcseleV13_8.main.controller.Login;
...
//        }
    ...
    public void setUp() throws Exception {
        ...
        /*DataSetManager.createPartialDataSet("select PRUEBA, NUM_POLIZA, FECHA_EMISION, PRODUCTO from BUSQUEDA_POLIZA",
                "BUSQUEDA_POLIZA",
                "C:/AcseleTests/AutomationTestAcsele/src/AcseleV13_8.tests.xmls/consultaPolizaAvanzada2_dataset.xml");

        DataSetManager.createPartialDataSet("select PRUEBA, NUM_POLIZA, FECHA_EMISION, PRODUCTO from BUSQUEDA_POLIZA",
                "BUSQUEDA_POLIZA",
                "C:/AcseleTests/AutomationTestAcsele/target/classes/AcseleV13_8.tests.xmls/consultaPolizaAvanzada2_dataset.xml");
        */

        DataSetManager.loadDataSet("/AcseleV13_8/tests/xmls/consultaPolizaAvanzada2_dataset.xml", DataSetManager.REFRESH_OPERATION);
    }

    @After
    public void tearDown() throws Exception {

        DataSetManager.loadDataSet("/AcseleV13_8/tests/xmls/consultaPolizaAvanzada2_dataset.xml", DataSetManager.DELETE_OPERATION);
    }
}

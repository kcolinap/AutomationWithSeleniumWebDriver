...
import AcseleV13_8.main.controller.ImpresionDocumentosNivelPoliza;
 ...
 */
public class VistaImpresionDocumentosNivelPolizaTest {
    ...
    public void mainTest() {
        ...
        try {
            impDocPoliza = ImpresionDocumentosNivelPolizaBean.getImpresionDocNivelPoliza();
        ...
        for(int i = 0; i < impDocPoliza.size(); i++) {
            ...
            ImpresionDocumentosNivelPolizaBean impresionDocumentosNivelPolizaBean = (ImpresionDocumentosNivelPolizaBean) impDocPoliza.get(i);
            ImpresionDocumentosNivelPoliza a = new ImpresionDocumentosNivelPoliza();

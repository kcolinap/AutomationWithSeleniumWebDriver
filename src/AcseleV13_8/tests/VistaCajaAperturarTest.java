...
import AcseleV13_8.main.controller.CajaAperturar;
...
/*        DataSetManager.createPartialDataSet("SELECT PRUEBA, NUM_CAJA FROM APERTURAR_CAJA ORDER BY PRUEBA ASC",
                "APERTURAR_CAJA",
                "C:/AcseleTests/AutomationTestAcsele/src/AcseleV13_8.tests.xmls/cajaAperturar_dataset.xml");

        DataSetManager.createPartialDataSet("SELECT PRUEBA, NUM_CAJA FROM APERTURAR_CAJA ORDER BY PRUEBA ASC",
                "APERTURAR_CAJA",
                "C:/AcseleTests/AutomationTestAcsele/target/classes/AcseleV13_8.tests.xmls/cajaAperturar_dataset.xml");
*/
        DataSetManager.loadDataSet("/AcseleV13_8/tests/xmls/cajaAperturar_dataset.xml", DataSetManager.REFRESH_OPERATION);
    }

    @After
    public void tearDown() throws Exception{
        DataSetManager.loadDataSet("/AcseleV13_8/tests/xmls/cajaAperturar_dataset.xml", DataSetManager.DELETE_OPERATION);
    }
}

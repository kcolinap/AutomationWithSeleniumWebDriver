...
public class AprobarEnviarPagoSiniestros {
    ...
    public void testLink (AprobarEnviarPagoSiniestrosBean aprobarEnviarPagoSiniestrosBean, int i )  throws IOException, InterruptedException {
        ...
        BuscarSiniestro(driver, a, aprobarEnviarPagoSiniestrosBean, i);
        Thread.sleep(3000);



        Thread.sleep(3000);
        EditarPago(driver, a, aprobarEnviarPagoSiniestrosBean, i);

        Thread.sleep(3000);

        CambiarEstado(driver, a, aprobarEnviarPagoSiniestrosBean, i);
        ...
        Sucursal (driver, a, aprobarEnviarPagoSiniestrosBean, i);

        Thread.sleep(3000);

        EnviarPago(driver, a, aprobarEnviarPagoSiniestrosBean, i);
    ...
    public void BuscarSiniestro(WebDriver driver, Metodos13_8 a, AprobarEnviarPagoSiniestrosBean aprobarEnviarPagoSiniestrosBean, int i) throws IOException, InterruptedException{
        ...
        try {
            ...
            crearPago.click();
          //Thread.sleep(3000);
          //a.ScreenShotPool(driver, "screen7", nombreAutomatizacion);
            Thread.sleep(5000);
...
*/
            ...
            ruta.click();
          //  Thread.sleep(2000);
          //  a.ScreenShotPool(driver, "screen10", nombreAutomatizacion);

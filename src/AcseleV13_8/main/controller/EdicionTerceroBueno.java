...
public class EdicionTerceroBueno {
    ...
    public void BuscarTercero(Metodos13_8 a, WebDriver driver, EdicionTercerosBuenosBean edicionTercerosBuenosBean, int i) throws InterruptedException, IOException {

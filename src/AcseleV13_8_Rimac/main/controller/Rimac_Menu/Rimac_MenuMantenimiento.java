 ...
 */
public class Rimac_MenuMantenimiento {

    protected ThreadLocal<WebDriver> threadDriver = null;

    private final static Logger log = Logger.getLogger(Rimac_MenuMantenimiento.class);
    ...
    /** Mantenimiento de Tercero **/
        ...
        public void MantTerc_BuscarTercero(WebDriver driver, String nombreAutomatizacion, int i, int numScreenShoot, String folderName){

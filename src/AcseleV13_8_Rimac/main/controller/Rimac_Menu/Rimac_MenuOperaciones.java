 ...
 */
public class Rimac_MenuOperaciones {

    protected ThreadLocal<WebDriver> threadDriver = null;

    private final static Logger log = Logger.getLogger(Rimac_MenuOperaciones.class);
    ...
    public void OpeSini_CreacionSiniestro(WebDriver driver, Metodos a,  String nombreAutomatizacion, int numScreenShoot, int i){
        try{
            ...
            WebElement menu1 = driver.findElement(By.xpath("/html/body/div[1]/div[2]"));//operacion
            WebElement menu2 = driver.findElement(By.xpath("/html/body/div[3]/div[3]"));//operaciones siniestros
            WebElement menu3 = driver.findElement(By.xpath("/html/body/div[8]/div[6]"));//creacion de siniestro
            action.moveToElement(menu1).build().perform();
            action.moveToElement(menu2).build().perform();
            action.moveToElement(menu3).build().perform();
            Thread.sleep(1000);
    ...
    /** Cumulos **/
    public void Cumulos_CumulosPorTerceros(WebDriver driver, String nombreAutomatizacion, int numScreenShoot, int i, String folderName) throws IOException, InterruptedException{
    ...
    public void Cumulos_CumulosPorAsegurado(WebDriver driver, String nombreAutomatizacion, int numScreenShoot, int i, String folderName)throws IOException, InterruptedException{

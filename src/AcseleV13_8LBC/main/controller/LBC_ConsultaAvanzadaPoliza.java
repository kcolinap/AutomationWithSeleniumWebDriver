 ...
 */
public class LBC_ConsultaAvanzadaPoliza {

    private final static Logger log = Logger.getLogger(LBC_ConsultaAvanzadaPoliza.class);
    ...
    public void testLink(LBC_ConsultaAvanzadaPolizaBean lbcConsultaAvanzadaPolizaBean, int i)throws Exception {
        ...
        BuscarPolizaAvanzada(a, driver, lbcConsultaAvanzadaPolizaBean, i);
    }

    public void BuscarPolizaAvanzada(LBC_Metodos a, WebDriver driver, LBC_ConsultaAvanzadaPolizaBean lbcConsultaAvanzadaPolizaBean, int i) throws InterruptedException, IOException {
        ...
        if (lbcConsultaAvanzadaPolizaBean.getProducto() != null){
            Select tipoProducto = new Select(driver.findElement(By.xpath("//select[@wicketpath='ConsultPolicy_searchForm_productsList']")));

            tipoProducto.selectByValue(lbcConsultaAvanzadaPolizaBean.getProducto());
            Thread.sleep(2000);
        }


        // Estado del ciclo de vida
        if (lbcConsultaAvanzadaPolizaBean.getEdoCicloVida() != null){
            Select edoCicloVida = new Select(driver.findElement(By.xpath("//select[@wicketpath='ConsultPolicy_searchForm_stateProductsList']")));
            edoCicloVida.selectByValue(lbcConsultaAvanzadaPolizaBean.getEdoCicloVida());
            Thread.sleep(1000);
        }
        // Fecha de Emision
        if (lbcConsultaAvanzadaPolizaBean.getFechaEmision() != null){
            ...
            fechaEmision.sendKeys(lbcConsultaAvanzadaPolizaBean.getFechaEmision());
            Thread.sleep(1000);
        }

        // Num Poliza
        if (lbcConsultaAvanzadaPolizaBean.getNumPoliza() != null){
            ...
            numeroPolza.sendKeys(lbcConsultaAvanzadaPolizaBean.getNumPoliza());
            Thread.sleep(1000);
        }

...
public class LBC_ConsultaAvanzadaPoliza {
    ...
    public void testLink(LBC_ConsultaAvanzadaPolizaBean consultaAvanzadaPolizaBean, int i)throws Exception {
    ...
    public void BuscarPolizaAvanzada(LBC_Metodos a, WebDriver driver, LBC_ConsultaAvanzadaPolizaBean consultaAvanzadaPolizaBean, int i) throws InterruptedException, IOException {

...
public class LBC_CumulosProducto {
    ...
    public void testLink(LBC_CumulosProductoBean lbcCumulosProductoBean,int i) throws IOException, InterruptedException {
        ...
        BusquedaProductos(driver, a, lbcCumulosProductoBean,i);


    }


    public void BusquedaProductos (WebDriver driver, LBC_Metodos a, LBC_CumulosProductoBean lbcCumulosProductoBean, int i) throws IOException, InterruptedException{

        try{
            Thread.sleep(3000);
            a.ScreenShotPool(driver,i,"screen4",nombreAutomatizacion);
            Select producto = new Select(driver.findElement(By.xpath("//*[@id=\"products\"]")));
            producto.selectByValue(lbcCumulosProductoBean.getProducto());

            Thread.sleep(1000);
            Select moneda = new Select(driver.findElement(By.xpath("//*[@id=\"money\"]")));
            moneda.selectByValue(lbcCumulosProductoBean.getMoneda());

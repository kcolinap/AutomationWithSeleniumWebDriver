 ...
 */
public class ConsultaSimplePoliza {

    private final static Logger log = Logger.getLogger(ConsultaSimplePoliza.class);
...
//        WebElement fieldNumPoliza = driver.findElement(By.xpath("//*[@id=\"idd\"]"));
        ...
        fieldNumPoliza.sendKeys(consultaSimplePolizaBean.getNumPoliza());

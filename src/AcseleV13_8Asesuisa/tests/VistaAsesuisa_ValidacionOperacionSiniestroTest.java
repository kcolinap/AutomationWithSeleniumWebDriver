 ...
 */
public class VistaAsesuisa_ValidacionOperacionSiniestroTest {
    private final static Logger Log = Logger.getLogger(VistaAsesuisa_ValidacionOperacionSiniestroTest.class);

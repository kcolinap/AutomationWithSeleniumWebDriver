...
public class Asesuisa_MenuMantenimiento {
    ...
    /** Mantenimiento de Tercero **/
        ...
        public void MantTerc_IngresarTercero(WebDriver driver, String nombreAutomatizacion, int numScreenShoot, int i, String folderName){

            try {
                Actions action = new Actions(driver);
                WebElement menu1 = driver.findElement(By.xpath("/html/body/div[3]/div[4]")); // Mantenimiento
                WebElement menu2 = driver.findElement(By.xpath("/html/body/div[36]/div[2]")); // Mantenimiento de Tercero
                WebElement menu3 = driver.findElement(By.xpath("/html/body/div[37]/div[1]")); // Nuevo
                menu1.click();
                menu2.click();
                Thread.sleep(1000);
        ...
        public void MantTerc_BuscarTercero(WebDriver driver, String nombreAutomatizacion, int numScreenShoot, int i, String folderName){
    ...
    /** UAA (Administracion de Cuentas Universal) **/
        ...
        public void UAA_Caja(WebDriver driver, String nombreAutomatizacion, int numScreenShoot, int i, String folderName){
        ...
        /** Facturacion **/
            public void UAA_Fac_DosificacionFacturas(WebDriver driver, String nombreAutomatizacion, int numScreenShoot, int i, String folderName){
                try {
                    Actions action = new Actions(driver);
                    WebElement menu1 = driver.findElement(By.xpath("/html/body/div[3]/div[4]")); // Mantenimiento
                    WebElement menu2 = driver.findElement(By.xpath("/html/body/div[36]/div[7]")); // UAA (Administrador de Cuentas Universal)
                    ...
                    action.moveToElement(menu5).build().perform();
                    Thread.sleep(1000);
                    a.ScreenShotPool(driver, i, "screen" + numScreenShoot, nombreAutomatizacion, folderName);
                    Toolkit.getDefaultToolkit().beep();
                    Thread.sleep(1000);
    ...
    public void AdminLisRest_CrearListasRestrictivas(WebDriver driver, String nombreAutomatizacion, int numScreenShoot, int i, String folderName){

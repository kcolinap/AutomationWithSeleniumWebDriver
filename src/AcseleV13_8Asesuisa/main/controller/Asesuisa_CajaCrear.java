 ...
 */
public class Asesuisa_CajaCrear {

    private final static Logger log = Logger.getLogger(Asesuisa_CajaCrear.class);

    public String nombreAutomatizacion = "Asesuisa Caja Crear";
    private WebDriver driver;

    public void testLink(Asesuisa_CajaCrearBean bean, int i, String folderName){
        ...
        try {
            ...
            //Entrando en Menu
            menuMantenimiento.UAA_Caja(driver, nombreAutomatizacion, 2, i, folderName);
            ...
            CrearCaja(bean,a, i, folderName, 3, 4, 5, 6, 7);
            Thread.sleep(3000);
    ...
    public void CrearCaja(Asesuisa_CajaCrearBean bean, Metodos a, int i, String folderName, int numScreenShoot, int numScreenShoot2, int numScreenShoot3, int numScreenShoot4, int numScreenShoot5){

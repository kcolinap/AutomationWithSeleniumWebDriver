 ...
 */
public class Asesuisa_PolizaEmisionVariasURAutomotores {

    private final static Logger log = Logger.getLogger(Asesuisa_PolizaEmisionVariasURAutomotores.class);

    public String nombreAutomatizacion = "Asesuisa Emision Poliza con Varias UR";
    private WebDriver driver;

    public void testLink(Asesuisa_PolizaEmisionVariasURAutomotoresBean bean, int i, String folderName){
        ...
        try {
            ...
            Thread.sleep(2000);
            unidadRiesgo.UnidadesRiesgoAutomotores2(a, driver, bean, nombreAutomatizacion, i, folderName, 21);
            Thread.sleep(2000);
            objetoAsegurado.ObjetoAseguradoAutomotores2(a, driver, bean, nombreAutomatizacion, i, folderName, 22, 23, 24, 25, 26, 27, 28, 29);
            Thread.sleep(2000);
            objetoAsegurado.Asegurado2(a, driver, bean, nombreAutomatizacion, i, folderName, 30, 31);
            Thread.sleep(2000);
            finalizarPoliza.Calcular(a, driver, nombreAutomatizacion, i, folderName, 32, 33);
            Thread.sleep(2000);
            finalizarPoliza.ResumenAplicar(a, driver, nombreAutomatizacion, i, folderName, 34);
            Thread.sleep(2000);
            finalizarPoliza.ResumenPoliza(a, driver, nombreAutomatizacion, i, folderName, 35);

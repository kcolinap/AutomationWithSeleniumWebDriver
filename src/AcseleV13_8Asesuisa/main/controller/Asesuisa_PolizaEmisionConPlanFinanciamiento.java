 ...
 */
public class Asesuisa_PolizaEmisionConPlanFinanciamiento {

    private final static Logger log = Logger.getLogger(Asesuisa_PolizaEmisionConPlanFinanciamiento.class);

    public String nombreAutomatizacion = "Asesuisa Emision Poliza con Plan de Financiamiento";
    private WebDriver driver;

    public void testLink(Asesuisa_PolizaEmisionConPlanFinanciamientoBean bean, int i, String folderName){
        ...
        try {
            ...
            if (!prueba) {
                ...
                finalizarPoliza.ResumenAplicar(a, driver, nombreAutomatizacion, i, folderName, 15);
                Thread.sleep(2000);
                finalizarPoliza.ResumenPoliza(a, driver, nombreAutomatizacion, i, folderName, 16);
            }
            else {
                Thread.sleep(1000);

 ...
 */
public class Asesuisa_BusquedaSimplePoliza {

    private final static Logger log = Logger.getLogger(Asesuisa_BusquedaSimplePoliza.class);

    public String nombreAutomatizacion = "Asesuisa Busqueda Simple Poliza";
    private WebDriver driver;

    public void testLink(Asesuisa_BusquedaSimplePolizaBean bean, int i, String folderName){
    ...
    public void FormularioBusqueda(Asesuisa_BusquedaSimplePolizaBean bean, Metodos a, int i, String folderName, int numScreenShoot, int numScreenShoot2, int numScreenShoot3, int numScreenShoot4, int numScreenShoot5){

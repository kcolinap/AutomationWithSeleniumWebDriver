...
//             log.info(e);
    ...
    public void CrearPoliza(Metodos a, WebDriver driver, EmisionPolizaVariosOABean emisionPolizaVariosOABean) throws InterruptedException {

        // //TipoElemento[@wicketpath='WicketpathElemento']
        Thread.sleep(2000);
        AdminitracionPropuestaPoliza(a, driver, emisionPolizaVariosOABean);
        Thread.sleep(3000);
        EventoAplicar(a, driver, emisionPolizaVariosOABean);
        Thread.sleep(4000);
    ...
    public void AdminitracionPropuestaPoliza(Metodos a, WebDriver driver, EmisionPolizaVariosOABean emisionPolizaVariosOABean){
        try {
...
//             log.info(e);
    ...
    public void EventoAplicar(Metodos a, WebDriver driver, EmisionPolizaVariosOABean emisionPolizaVariosOABean){
        try {
            Thread.sleep(3000);
...
//             log.info(e);
    ...
    public void TomadorTercero(Metodos a, WebDriver driver, EmisionPolizaVariosOABean emisionPolizaVariosOABean){
        try {
...
//             log.info(e);
    ...
    public void UnidadRiesgo(Metodos a, WebDriver driver, EmisionPolizaVariosOABean emisionPolizaVariosOABean){
        try {
            // Primera UR

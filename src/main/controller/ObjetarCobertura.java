    ...
    public void BuscarPoliza(WebDriver driver, Metodos a, ObjetarCoberturaBean objetarCoberturaBean) throws IOException, InterruptedException{
        ...
        try {
            ...
            if (objetarCoberturaBean.getProducto() != null){
                Thread.sleep(2000);
                Select producto = new Select(driver.findElement(By.xpath("/*/
/*[@id=\"_productId\"]")));
            ...
            if (objetarCoberturaBean.getEstadosCicloVida() != null){
                Thread.sleep(2000);
                Select estadosCicloVida = new Select(driver.findElement(By.xpath("/*/
/*[@id=\"_stateProductId\"]")));
            ...
            if (objetarCoberturaBean.getContratante() != null){
                Thread.sleep(2000);
                WebElement contratante = driver.findElement(By.xpath("/*/
/*[@id=\"_clientName\"]"));
            ...
            if (objetarCoberturaBean.getAsegurado() != null){
                Thread.sleep(2000);
                WebElement asegurado = driver.findElement(By.xpath("/*/
/*[@id=\"_insuredName\"]"));
            ...
            if (objetarCoberturaBean.getIdPoliza() != null){
                Thread.sleep(2000);
                WebElement idPoliza = driver.findElement(By.xpath("/*/
/*[@id=\"_policyId\"]" ));
            ...
            if (objetarCoberturaBean.getFechaDesde() != null){
                Thread.sleep(2000);
                WebElement fechaDesde = driver.findElement(By.xpath("/*/
/*[@id=\"_fromDateShow\"]" ));
...
/*[@id=\"1933934\"]/td[3]/font/input[1]" ));
            ...
            if (objetarCoberturaBean.getFechaProximaGeneracionPrima() != null){
                Thread.sleep(2000);
                WebElement fechaProximaGeneracionPrima = driver.findElement(By.xpath("/*/
/*[@id=\"1830374\"]/td[3]/font/input[1]" ));
            ...
            if (objetarCoberturaBean.getFechaProximaFacturacion() != null){
                Thread.sleep(2000);
                WebElement fechaProximaFacturacion = driver.findElement(By.xpath("/*/
/*[@id=\"1830214\"]/td[3]/font/input[1]" ));
            ...
            if (objetarCoberturaBean.getTipoPoliza() != null){
                Thread.sleep(2000);
                Select tipoPoliza = new Select(driver.findElement(By.xpath("/*/
/*[@id=\"2878614\"]/td[3]/font/select")));
                tipoPoliza.selectByValue(objetarCoberturaBean.getTipoPoliza());
            }

            if (objetarCoberturaBean.getNumeroCotizacion() != null){
                Thread.sleep(2000);
                WebElement numeroCotizacion = driver.findElement(By.xpath("/*/
/*[@id=\"9480594\"]/td[3]/font/input[1]" ));
                numeroCotizacion.sendKeys(objetarCoberturaBean.getNumeroCotizacion());
            }

            if (objetarCoberturaBean.getNumeroPropuesta() != null){
                Thread.sleep(2000);
                WebElement numeroPropuesta = driver.findElement(By.xpath("/*/
/*[@id=\"9452594\"]/td[3]/font/input[1]" ));
                numeroPropuesta.sendKeys(objetarCoberturaBean.getNumeroPropuesta());
            }

            if (objetarCoberturaBean.getTipoMoneda() != null){
                Thread.sleep(2000);
                Select tipoMoneda = new Select(driver.findElement(By.xpath("/*/
/*[@id=\"29008194\"]/td[3]/font/select")));
                tipoMoneda.selectByValue(objetarCoberturaBean.getTipoMoneda());
            }

            Thread.sleep(1000);
            a.ScreenShot(driver,"screen4",nombreAutomatizacion);

            WebElement btnBuscar = driver.findElement(By.xpath("/*/
/*[@id=\"idb_040201401_searchformpolicy_01\"]"));
            btnBuscar.click();
...
//                log.info(e);
    ...
    public void ResultadoBusqueda (WebDriver driver, Metodos a, ObjetarCoberturaBean objetarCoberturaBean){
        try {
            Thread.sleep(2000);
            WebElement fechaOcurrenciaSiniestro = driver.findElement(By.xpath("/*/
/*[@id=\"tableHeader\"]/tbody/tr/td[2]/input[4]"));
            fechaOcurrenciaSiniestro.sendKeys(objetarCoberturaBean.getFechaOcurrenciaSiniestro());

            Thread.sleep(2000);
            Select sucursalSiniestros = new Select(driver.findElement(By.xpath("/*/
/*[@id=\"userAgency\"]")));
            ...
            Thread.sleep(2000);
            WebElement btnSeleccionarPoliza = driver.findElement(By.xpath("/*/
/*[@id=\"form1\"]/table/tbody/tr/td[1]/input"));
            ...
            WebElement btnSelecUnidadesRiesgo = driver.findElement(By.xpath("/*/
/*[@id=\"idb_040201401_searchresult_02\"]"));
...
/*[@id=\"idb_0402006_selectRiskUnitToClaim_05\"]"));
            btnEnviar.click();

            Thread.sleep(10000);


            WebElement btnSelecEvento = driver.findElement(By.xpath("/*/
/*[@id=\"idb_040201401_searchresult_03\"]"));
            ...
            btnEnviar = driver.findElement(By.xpath("/*/
/*[@id=\"idb_0402006_policyEventsToClaim_01\"]"));
            btnEnviar.click();

            Thread.sleep(8000);

            WebElement btnAceptar = driver.findElement(By.xpath("/*/
/*[@id=\"idb_040201401_searchresult_07\"]"));
            btnAceptar.click();
...
//                log.info(e);
    ...
    public void AgregarObjetoAfectado (WebDriver driver, Metodos a, ObjetarCoberturaBean objetarCoberturaBean){
        try {
            Thread.sleep(2000);
            WebElement btnAgregar = driver.findElement(By.xpath("/*/
/*[@id=\"idb_0402006_structure_01\"]"));
            btnAgregar.click();
            ...
            Select horaOcurrencia = new Select(driver.findElement(By.xpath("/*/
/*[@id=\"1837254\"]/td[3]/font/select")));
            horaOcurrencia.selectByValue(objetarCoberturaBean.getHoraOcurrencia());

            WebElement fechaAvisoCompania = driver.findElement(By.xpath("/*/
/*[@id=\"1837174\"]/td[3]/font/input[1]"));
            fechaAvisoCompania.sendKeys(objetarCoberturaBean.getFechaAvisoCompania());

            if (objetarCoberturaBean.getHoraNotificacion() != null){
                Select horaNotificacion = new Select(driver.findElement(By.xpath("/*/
/*[@id=\"9486594\"]/td[3]/font/select")));
            ...
            if (objetarCoberturaBean.getFechaReclFormalizacion() != null){
                WebElement fechaReclFormalizacion = driver.findElement(By.xpath("/*/
/*[@id=\"28932594\"]/td[3]/font/input[1]"));
            ...
            if (objetarCoberturaBean.getFechaInterrupcionTerminos() != null){
                WebElement fechaInterrupcionTerminos = driver.findElement(By.xpath("/*/
/*[@id=\"30022594\"]/td[3]/font/input[1]"));
            ...
            if (objetarCoberturaBean.getReclamante() != null){
                WebElement reclamante = driver.findElement(By.xpath("/*/
/*[@id=\"23937694\"]/td[3]/font/input[1]"));
                reclamante.sendKeys(objetarCoberturaBean.getReclamante());
            }

            if (objetarCoberturaBean.getCausaMuerte() != null){
                Select causaMuerte = new Select(driver.findElement(By.xpath("/*/
/*[@id=\"23854894\"]/td[3]/font/select")));
                causaMuerte.selectByValue(objetarCoberturaBean.getCausaMuerte());
            }

            if (objetarCoberturaBean.getCausalesCoberturaMuerte() != null){
                Select causalesCoberturaMuerte = new Select(driver.findElement(By.xpath("/*/
/*[@id=\"29997794\"]/td[3]/font/select")));
                causalesCoberturaMuerte.selectByValue(objetarCoberturaBean.getCausalesCoberturaMuerte());
            }

            Select departamento = new Select(driver.findElement(By.xpath("/*/
/*[@id=\"1934614\"]/td[3]/font/select")));
            departamento.selectByValue(objetarCoberturaBean.getDepartamento());

            if (objetarCoberturaBean.getCiudad() != null){
                Select ciudad = new Select(driver.findElement(By.xpath("/*/
/*[@id=\"9508794\"]/td[3]/font/select")));
                ciudad.selectByValue(objetarCoberturaBean.getCiudad());
            }

            if (objetarCoberturaBean.getActividadSiniestro() != null){
                Select actividadSiniestro = new Select(driver.findElement(By.xpath("/*/
/*[@id=\"30018694\"]/td[3]/font/select")));
            ...
            if (objetarCoberturaBean.getFechaActividad() != null){
                WebElement fechaActividad = driver.findElement(By.xpath("/*/
/*[@id=\"30018794\"]/td[3]/font/input[1]"));
                fechaActividad.sendKeys(objetarCoberturaBean.getFechaActividad());
            }

            if (objetarCoberturaBean.getObservacionesSiniestro() != null){
                WebElement observacionesSiniestro = driver.findElement(By.xpath("/*/
/*[@id=\"3746174\"]/td[3]/font/textarea"));
...
/*[@id=\"idb_0402006_structure_04\"]"));
            ...
            Thread.sleep(2000);
            WebElement pagoMaximo = driver.findElement(By.xpath("/*/
/*[@id=\"maxBenefitAmount1\"]"));
            pagoMaximo.clear();
            ...
            WebElement btnEnviar = driver.findElement(By.xpath("/*/
/*[@id=\"idb_0402006_addCoverages_03\"]"));
            btnEnviar.click();
            ...
            WebElement btnObjetar = driver.findElement(By.xpath(""));
            btnObjetar.click();
            ...
            Select motivosObejecion = new Select(driver.findElement(By.xpath("")));
            motivosObejecion.selectByValue(objetarCoberturaBean.getMotivosObjecion());

            if (objetarCoberturaBean.getFechaObjecion() != null){
                WebElement fechaObjecion = driver.findElement(By.xpath(""));
                fechaObjecion.sendKeys(objetarCoberturaBean.getFechaObjecion());
            }

            if (objetarCoberturaBean.getComentariosSiniestro() != null){
                WebElement comentariosSiniestro = driver.findElement(By.xpath("/*/
/*[@id=\"idb_0402006_structure_07\"]"));
                comentariosSiniestro.sendKeys(objetarCoberturaBean.getComentariosSiniestro());
            }
